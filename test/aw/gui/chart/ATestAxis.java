...
public abstract class ATestAxis extends TestCase {
  ...
  public void testRoundToTicks() {
    double xmax = this.axisX.getMax();
    double xmin = this.axisX.getMin();
    double xrange = xmax - xmin;
    double roundXmin = this.axisX.roundToTicks(this.trace.getMinX(), true).m_value;
    ...
    // ticks).
    double roundXmin2 = this.axisX.roundToTicks(roundXmin, true).m_value;
