/*
 *  AccumulatingIteratorConseCutivePointsOrderedXValues.java of project jchart2d, <enterpurposehere>. 
...
/**
 * Tests for {@link AccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity}.
 * <p>
 * 
 * 
 ...
 * 
 */
public class TestAccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity {
  ...
  public void testEmptyTraceAccumulationFunctionArithmeticMeanXY() {
    ...
    AAccumulationIterator toTest = new AccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity(this.m_trace, accumulationFunction, 0);
...
//    AAccumulationIterator toTest = new AccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity(this.m_trace, accumulationFunction, this.m_trace.getSize());
  ...
  public void testThreeValueTraceAccumulationFunctionArithmeticMeanXYWithRequestToAccumulate2into1() {
    ...
    AAccumulationIterator toTest = new AccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity(this.m_trace, accumulationFunction, 2);
    Assert.assertTrue(toTest.hasNext());
    ITracePoint2D result = toTest.next();
    Assert.assertEquals(one, result);
    Assert.assertTrue(toTest.hasNext());
  ...
  public void testFourValueTraceAccumulationFunctionArithmeticMeanXYWithRequestToAccumulate2into1() {
    ...
    AAccumulationIterator toTest = new AccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity(this.m_trace, accumulationFunction, 3);
    Assert.assertTrue(toTest.hasNext());
    ITracePoint2D result = toTest.next();
    Assert.assertEquals(one, result);
    Assert.assertTrue(toTest.hasNext());
  ...
  public void test102ValueTraceAccumulationFunctionArithmeticMeanXYWithRequestToAccumulate2into1() {
    ...
    AAccumulationIterator toTest = new AccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity(this.m_trace, accumulationFunction, 52);
    Assert.assertTrue(toTest.hasNext());
    ITracePoint2D result = toTest.next();
  ...
  public void test92ValueTraceAccumulationFunctionArithmeticMeanXYWithRequestToAccumulate3into1() {
    ...
    AAccumulationIterator toTest = new AccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity(this.m_trace, accumulationFunction, 32);
    Assert.assertTrue(toTest.hasNext());
    ITracePoint2D result = toTest.next();
    Assert.assertEquals(first, result);
  ...
  public void testReturnsLaterInvisible() {
    ...
    this.m_trace.addPoint(three);
    this.m_trace.addPoint(four);
    Iterator<ITracePoint2D> toTest = new AccumulatingIteratorConsecutivePointsOrderedXValuesWithRespectToDensity(this.m_trace, accumulationFunction, 1);
    Assert.assertTrue(toTest.hasNext());
    ITracePoint2D result = toTest.next();
    Assert.assertEquals(two, result);
