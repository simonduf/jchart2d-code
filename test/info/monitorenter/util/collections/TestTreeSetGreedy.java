...
public class TestTreeSetGreedy
   ...
   */
  public void testAdd() {
    assertNotNull(this.m_test);

    this.m_test.add(new Element());
    assertEquals(1, this.m_test.size());
  }
  ...
  public void testAdd10RemoveCenter() {
    ...
    assertEquals("Unexpected size: " + this.m_test, this.m_test.size(), 9);
  }
  ...
  public void testAddEqual10() {
    ...
    System.out.println(this.m_test);
    assertEquals(10, this.m_test.size());
  }
  ...
  public void testAddEqual2() {
    ...
    System.out.println(this.m_test);
    assertEquals(this.m_test.size(), 2);
  }
  ...
  public void testAddEqual3() {
    ...
    System.out.println(this.m_test);
    assertEquals(3, this.m_test.size());
  }
  ...
  public void testAddEqual5() {
    ...
    System.out.println(this.m_test);
    assertEquals(5, this.m_test.size());
  }
  ...
  public void testAddRemoveEqual10() {
    ...
    assertEquals("Unexpected remaining elements: " + this.m_test, this.m_test.size(), 0);
  }
