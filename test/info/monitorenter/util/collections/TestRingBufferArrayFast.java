...
public class TestRingBufferArrayFast
   ...
   */
  public void testAdd() {
    final RingBufferArrayFast ringBuffer = new RingBufferArrayFast(1);
  ...
  public void testIteratorF2L() {
    final IRingBuffer ringBuffer = new RingBufferArrayFast(10);
  ...
  public void testSetBufferSize() {
    final IRingBuffer buffer = new RingBufferArrayFast(3);
    ...
    final Iterator it = buffer.iteratorL2F();
    Assert.assertEquals(1, ((Integer) it.next()).intValue());
    Assert.assertEquals(2, ((Integer) it.next()).intValue());
    Assert.assertFalse(it.hasNext());
  }
  ...
  public void testSize() {
    ...
    final RingBufferArrayFast ringBuffer = new RingBufferArrayFast(100);
    System.out
