...
public class Chart2DActionSetGridX extends AChart2DAction {
  ...
  /** Defines if the grid is turned on or off. */
   ...
   *
   */
  public Chart2DActionSetGridX(final Chart2D chart, final String description, final boolean value) {
  ...
  public void actionPerformed(final ActionEvent e) {
    this.m_chart.setGridY(this.m_value);
  }
}
