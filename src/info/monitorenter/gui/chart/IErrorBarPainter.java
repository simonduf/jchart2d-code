 ...
 * with an additional {@link info.monitorenter.gui.chart.IErrorBarValue} for getting
 * information about the error to render.
 * <p>
 * 
 ...
 * The following {@link java.beans.PropertyChangeEvent} instances will be fired
 * to registered {@link java.beans.PropertyChangeListener} instances. <table
 * border="0">
 * <tr>
 ...
 * <td><code>{@link info.monitorenter.gui.chart.IPointPainter}</code>.</td>
 * <td>Note that null as the old value indicates a new painter. Null as the new
 * value is valid and means that the end point rendering is turned off.</td>
 * </tr>
 * <tr>
 ...
 * <td><code>{@link info.monitorenter.gui.chart.IPointPainter}</code>.</td>
 * <td>Note that null as the old value indicates a new painter. Null as the new
 * value is valid and means that the start point rendering is turned off.</td>
 * </tr>
 * <tr>
 * <td><code>{@link #PROPERTY_SEGMENT}</code></td>
 * <td><code>{@link IErrorBarPainter}</code> that changed.</td>
 * <td><code>{@link info.monitorenter.gui.chart.IPointPainter}</code>.</td>
 * <td><code>{@link info.monitorenter.gui.chart.IPointPainter}</code>.</td>
 * <td>Note that null as the old value indicates a new painter. Null as the new
 * value is valid and means that the segment point rendering is turned off.</td>
 * </tr>
 * <tr>
 ...
 * <td><code>{@link java.awt.Color}</code>.</td>
 * <td>Note that null as the old value indicates a new color different from the
 * default. Null as the new value is valid and means that the end point color is
 * switched to default.</td>
 * </tr>
 * <tr>
 ...
 * <td><code>{@link java.awt.Color}</code>.</td>
 * <td>Note that null as the old value indicates a new color different from the
 * default. Null as the new value is valid and means that the start point color
 * is switched to default.</td>
 * </tr>
 * <tr>
 * <td><code>{@link #PROPERTY_SEGMENT_COLOR}</code></td>
 * <td><code>{@link IErrorBarPainter}</code> that changed.</td>
 * <td><code>{@link java.awt.Color}</code>.</td>
 * <td><code>{@link java.awt.Color}</code>.</td>
 * <td>Note that null as the old value indicates a new color different from the
 * default. Null as the new value is valid and means that the segment color is
 * switched to default.</td>
 * </tr>
 * </table>
 * <p>
...
public interface IErrorBarPainter {
  ...
  /**
   * The property key defining the <code>segmentColor</code> property. Use in
   * combination with
   * {@link #addPropertyChangeListener(String, PropertyChangeListener)}.
   */
  public static final String PROPERTY_SEGMENT_COLOR = "errorbar.segment.color";
  ...
  /**
   * The property key defining the <code>segment</code> property. Use in
   * combination with
   * {@link #addPropertyChangeListener(String, PropertyChangeListener)}.
   */
  public static final String PROPERTY_SEGMENT = "errorbar.segment";
  ...
  /**
   * Returns the color of the segment or null if unconfigured.
   * <p>
   * 
   * @return the color of the segment or null if unconfigured.
   */
  public Color getSegmentColor();

  /**
   * Returns the painter for the segment of the error bar.
   * <p>
   * 
   * @return The painter for the segment of the error bar.
   */
  public IPointPainter getSegmentPainter();
   ...
   * the way of painting the segments, the start point (origin) and end point of
   * the error bar with implementations of {@link IPointPainter}.
   * <p>
   * 
   * @param absoluteX
   ...
   * have the same visual effect as setting such an instance for the segment
   * painter.
   * <p>
   * 
   ...
   * (to make the segment invisible). But the interface is open enough to use
   * implementations that would paint interpolated dots, discs, squares,...
   * whatever you think of (contribute!).
   * <p>
   * 
   * @param segmentPainter
   *          The segmentPainter to set.
   */
  public void setSegmentPainter(final IPointPainter segmentPainter);
