...
public interface IAxis extends Serializable {
  ...
  public final class AxisTitle implements Cloneable, Serializable {
    ...
    /**
     * Returns the title or <code>null</code> if there was no title configured before.
     * <p>
     * 
     * @return the title or <code>null</code> if there was no title configured before.
     */
    ...
    /**
     * Returns the width of this axis title in px with respect to the current title of the given
     * axis.
     * <p>
     * 
     * @param axis
     ...
     * @param g2d
     *            needed for size informations (e.g. font widths).
     * @return the width of this axis title in px with respect to the current title of the given
     *         axis.
     */
  ...
  /**
   * Constant for a <code>{@link java.beans.PropertyChangeEvent}</code> of the paint grid flag.
   */
   ...
   * Add a listener for the given property.
   * <p>
   * The following {@link java.beans.PropertyChangeEvent} types should be fired to listeners:<br>
   * <table border="0">
   * <tr>
   * <th><code>getPropertyName()</code></th>
   * <th><code>getSource()</code></th>
   ...
   * <td><code>{@link IAxis}</code> that changed</td>
   * <td><code>{@link IAxisLabelFormatter}</code>, the old value or null if there was no
   * formatter before. </td>
   ...
   * <p>
   * 
   * @return {@link Chart2D#CHART_POSITION_LEFT}, {@link Chart2D#CHART_POSITION_RIGHT},
   *         {@link Chart2D#CHART_POSITION_TOP}, {@link Chart2D#CHART_POSITION_BOTTOM} or -1 if
   *         this axis is not assigned to a chart.
   */
   ...
   * <p>
   * <b>Note:</b></br/> For an y axis the hight only includes the overhang it needs on the upper
   * edge for painting a complete lable, not the complete space it needs for the complete line.
   * <p>
   * 
   * @param g2d
  ...
  /**
   * Returns the maximum value from all traces of this axis with respect to the installed range
   * policy.
   * <p>
   * 
   * @return the maximum value from all traces of this axis with respect to the installed range
   *         policy.
   */
   ...
   * instances in all <code>{@link ITrace2D}</code> instances in this axis regardless of the
   * configured <code>{@link IRangePolicy}</code> (see
   * <code>{@link IAxis#setRangePolicy(IRangePolicy)}</code>). The returned value is either in x
   * or y dimension - depending on the dimension this axis is working in for the chart.
   * <p>
   * 
   * @return the maximum value of all <code>{@link info.monitorenter.gui.chart.TracePoint2D}</code>
   *         instances in all <code>{@link ITrace2D}</code> instances in this axis regardless of
   *         the configured <code>{@link IRangePolicy}</code> (see
   *         <code>{@link IAxis#setRangePolicy(IRangePolicy)}</code>).
   */
  public double getMaxValue();

  /**
   * Returns the minimum value of all traces of this axis with respect to the installed range
   * policy.
   * <p>
   * 
   * @return the minimum value of all traces of this axis with respect to the installed range
   *         policy.
   */
  ...
  /**
   * Returns the left pixel of this axis coordinate in the graphic context of the current paint
   * operation.
   * <p>
   * Note that this value is only valid throughout a
   * <code>{@link Chart2D#paint(java.awt.Graphics)}</code> invocation.
   * 
   * @return the left pixel coordinate of this axis in the graphic context of the current paint
   *         operation.
   */
  public int getPixelXLeft();

  /**
   * Returns the right pixel coordinate of this axis in the graphic context of the current paint
   * operation.
   * <p>
   * Note that this value is only valid throughout a
   * <code>{@link Chart2D#paint(java.awt.Graphics)}</code> invocation.
   * 
   * @return the right pixel coordinate of this axis in the graphic context of the current paint
   *         operation.
   */
  public int getPixelXRight();

  /**
   * Returns the bottom pixel coordinate of this axis in the graphic context of the current paint
   * operation.
   * <p>
   * Note that this value is only valid throughout a
   * <code>{@link Chart2D#paint(java.awt.Graphics)}</code> invocation.
   * 
   * @return the bottom pixel coordinate of this axis in the graphic context of the current paint
   *         operation.
   */
  public int getPixelYBottom();

  /**
   * Returns the top pixel coordinate of this axis in the graphic context of the current paint
   * operation.
   * <p>
   * Note that this value is only valid throughout a
   * <code>{@link Chart2D#paint(java.awt.Graphics)}</code> invocation.
   * 
   * @return the top pixel coordinate of this axis in the graphic context of the current paint
   *         operation.
   */
  ...
  /**
   * Scales the given absolute value into a value between 0 and 1.0 (if it is in the range of the
   * data).
   * <p>
   * If the given absolute value is not in the display- range of the <code>Chart2D</code>,
   * negative values or values greater than 1.0 may result.
   * <p>
   * 
   * @param absolute
   *            a value in the real value range of the corresponding chart.
   * @return a value between 0.0 and 1.0 that is mapped to a position within the chart.
   */
   ...
   * @return the labeled values that will be used by the <code>{@link Chart2D}</code> to paint
   *         labels.
   */
   ...
   * @return the title or <code>null</code> if there was no title configured before.
   * @see #getTitlePainter()
   * @deprecated use {@link #getAxisTitle()} and on the result {@link IAxis.AxisTitle#getTitle()}.
   */
  @Deprecated
  ...
  /**
   * Returns a <code>{@link Set}&lt;{@link ITrace2D}&gt;</code> with all traces covered by this
   * axis.
   * <p>
   * <b>Caution!</b><br/> The original internal modifiable set is returned for performance reasons
   * and by contract (to allow removing traces) so do not mess with it to avoid ugly unpredictable
   * side effects!
   * <p>
   * 
   * @return a <code>{@link Set}&lt;{@link ITrace2D}&gt;</code> with all traces covered by this
   *         axis.
   */
   ...
   * This includes the axis line, it's ticks and labels and it's title.
   * <p>
   * <b>Note:</b></br/> For an x axis the width only includes the overhang it needs on the right
   * edge for painting a complete label, not the complete space it needs for the complete line.
   * <p>
   * 
   * @param g2d
   *            needed for font metric information.
  ...
  /**
   * Returns true if this axis is responsible for rendering the scale of the given trace (<code>{@link IAxis#addTrace(ITrace2D)}</code>
   * was called on this instance with the given trace).
   * <p>
   * 
   * @param trace
   *            the trace to check for containment.
   * @return true if this axis is responsible for rendering the scale of the given trace (<code>{@link IAxis#addTrace(ITrace2D)}</code>
   *         was called on this instance with the given trace).
   */
  public boolean hasTrace(ITrace2D trace);

  /**
   * Allows to perform expensive calculations for various values that are used by many calls
   * throughout a paint iterations.
   * <p>
   ...
   * instances have changed since all points have been normalized to a value between 0 and 1 or true
   * if this axis has different range since the last call to <code>{@link IAxis#scale()}</code>.
   * <p>
   * 
   ...
   *         value between 0 and 1 or true if this axis has different range since the last call to
   ...
   * <p>
   * This should only be called from <code>{@link Chart2D}</code>, all other uses may cause
   * damaged UI or deadlocks.
   * <p>
   * 
   * @param g2d
   ...
   * @param g2d
   *            needed for painting.
   * @return the width consumed in pixel for y axis, the height consumed in pixel for x axis.
   */
  public int paintTitle(final Graphics g2d);

  /**
   * Convenience method for removing all contained <code>{@link ITrace2D}</code> instances of this
   * axis.
   * <p>
   * Implementations should fire a <code>{@link java.beans.PropertyChangeEvent}</code> for the
   * <code>{@link java.beans.PropertyChangeEvent#getPropertyName()}</code> 
   * <code>{@link IAxis#PROPERTY_ADD_REMOVE_TRACE}</code>
   * for every single trace removed. This is done best by delegating this call to several calls to
   ...
   * <code>{@link java.beans.PropertyChangeEvent#getPropertyName()}</code> 
   * <code>{@link IAxis#PROPERTY_ADD_REMOVE_TRACE}</code>
   * has to be fired on the registered <code>{@link PropertyChangeListener}</code> for the trace
   * removed.
   * <p>
   * 
   * @param trace
   *            the trace to remove from this axis.
   * @return true if the given trace could be removed from this axis, false else.
   */
  public boolean removeTrace(ITrace2D trace);

  /**
   * Scales all <code>{@link ITrace2D}</code> instances in the dimension represented by this axis.
   * <p>
  ...
  /**
   * Scales the given <code>{@link ITrace2D}</code> in the dimension represented by this axis.
   * <p>
   * This method is not deadlock - safe and should be called by the <code>{@link Chart2D}</code>
   * only!
   * <p>
   ...
   * <p>
   * The number that is passed-in represents the distance, measured in values, between each minor
   * tick mark. If you have a trace with a range from 0 to 10 and the minor tick spacing is set to
   * 2, you will get major ticks next to the following values: 0, 2, 4, 6, 8, 10. If a major tick
   * hits the same values the tick will be a major ticks. For this example: if a major tick spacing
   ...
   * 
   * @param pixel
   *            the left pixel coordinate of this axis in the graphic context of the current paint
   *            operation.
   */
  public void setPixelXLeft(int pixel);

  /**
   * Sets the right pixel of this axis coordinate in the graphic context of the current paint
   * operation.
   * <p>
   * This must only be called from the <code>{@link Chart2D}</code> itself!
   * <p>
   * 
   * @param pixel
   *            the right pixel coordinate of this axis in the graphic context of the current paint
   *            operation.
   */
  public void setPixelXRight(int pixel);

  /**
   * Sets the bottom pixel of this axis coordinate in the graphic context of the current paint
   * operation.
   * <p>
   * This must only be called from the <code>{@link Chart2D}</code> itself!
   * <p>
   * 
   * @param pixel
   *            the bottom pixel coordinate of this axis in the graphic context of the current paint
   *            operation.
   */
  public void setPixelYBottom(int pixel);

  /**
   * Sets the top pixel of this axis coordinate in the graphic context of the current paint
   * operation.
   * <p>
   * This must only be called from the <code>{@link Chart2D}</code> itself!
   * <p>
   * 
   * @param pixel
   *            the top pixel coordinate of this axis in the graphic context of the current paint
   *            operation.
   */
  ...
  /**
   * Sets the title of this axis will be painted by the <code>{IAxisTitlePainter}</code> of this
   * instance.
   * <p>
   * 
   * @param title
   *            the title to set.
   * @return the previous Title or <code>null</code> if there was no title configured before.
   * @see #setTitlePainter(IAxisTitlePainter)
   * @deprecated use {@link #getAxisTitle()} and on the result {@link AxisTitle#setTitle(String)}
   */
  @Deprecated
   ...
   * @return the previous title painter of this axis or null if there was none configured before.
   ...
   * <p>
   * Internal use only, the interface does not guarantee that the pixel corresponds to any valid awt
   * pixel value within the chart component.
   * <p>
   * 
   * @param pixel
