/*
 *  ErrorBarPaintersConfigarablePanel.java of project jchart2d, a panel 
 ...
 * {@link info.monitorenter.gui.chart.errorbars.ErrorBarPainterConfigureable}
 * instances of an {@link info.monitorenter.gui.chart.IErrorBarPolicy} and
 * offers their edit and remove buttons as well as an add button for a new
 ...
 */
public class ErrorBarPaintersConfigurablePanel
   ...
   */
  public ErrorBarPaintersConfigurablePanel(final IErrorBarPolicy errorBarPolicy) {
   ...
   * {@link info.monitorenter.gui.chart.errorbars.ErrorBarPainterConfigureable}
   * instance of an {@link info.monitorenter.gui.chart.IErrorBarPolicy} and
   * offers their edit and remove buttons as well as an add button for a new
   * {@link info.monitorenter.gui.chart.errorbars.ErrorBarPainterConfigureable}
  ...
  public class ErrorBarPainterConfigurablePanel
    ...
    public ErrorBarPainterConfigurablePanel(final IErrorBarPainter errorBarPainter,
      ...
      editButton = new JButton(new ErrorBarPainterActionEdit(errorBarPainter, "Edit"));
      ...
      if (IErrorBarPolicy.PROPERTY_ERRORBARPAINTER.equals(property)) {
        ...
        if (oldValue == this.m_errorBarPainter) {
          if (newValue == null) {
            ...
            // remove
            ErrorBarPaintersConfigurablePanel.this.remove(this);
            // also as a listener:
