    ...
    synchronized (this.m_renderer) {
      ...
      synchronized (this) {
        ...
        if (this.m_firsttime) {
          ...
          this.firePropertyChange(PROPERTY_MAX_X, this, new Double(this.m_maxX));
          this.firePropertyChange(PROPERTY_MIN_X, this, new Double(this.m_minX));
          this.firePropertyChange(PROPERTY_MAX_Y, this, new Double(this.m_maxY));
          this.firePropertyChange(PROPERTY_MIN_Y, this, new Double(this.m_minY));
  ...
  protected final void firePropertyChange(final String property, final Object oldvalue,
    ...
    if (property.equals(PROPERTY_MAX_X) || property.equals(PROPERTY_MAX_Y)
      ...
      if (!Thread.holdsLock(this.m_renderer)) {
        throw new RuntimeException("Acquire a look on the corresponding chart first!");
      }
    }
