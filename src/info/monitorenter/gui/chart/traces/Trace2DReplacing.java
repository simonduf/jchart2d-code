...
/**
 * Has the behaviour of <code>Trace2DBijective</code> and additional features.
 * <p>
 * <ul>
 * <li>All tracepoints that are added are stored unchanged in a LinkedList. </li>
 * <li>All traceoints added whose x- values are not already contained are added to the end.</li>
 * <li>If a tracepoint is inserted whose x - value already exists in the List, the old tracepoint
 * with that value will be replaced by the new tracepoint. </li>
 * </ul>
 * <p>
 * 
